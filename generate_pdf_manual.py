...
def build_pdf(filename: str = "manual_instalacion_sqlanywhere.pdf") -> None:
    try:
    ...
    story.append(
        Paragraph(
            "Manual de Instalación y Soporte de<br/>SAP SQL Anywhere en Apache Superset",
            title_style,
        )
    )
    story.append(
        Paragraph("Guía Completa de Despliegue Automatizado (Opción A)", subtitle_style)
    )
    story.append(Spacer(1, 200))

    meta_data = [
        [Paragraph("<b>Creado por:</b> Henry R.", body_style)],
    ...
    story.append(
        Paragraph("2. Preparación de la Opción A (Flujo de Trabajo)", h1_style)
    )
    story.append(
        Paragraph(
    ...
    story.append(
        Paragraph(
            "<b>Paso 1: Obtener el Instalador Cliente de SQL Anywhere para Linux</b>",
            h2_style,
        )
    )
    story.append(
    ...
    story.append(
        Paragraph("<b>Paso 2: Colocar el archivo en la raíz del proyecto</b>", h2_style)
    )
    story.append(
        Paragraph(
    ...
    story.append(
        Paragraph("3. Detalles de los Cambios Inyectados en el Proyecto", h1_style)
    )
    story.append(
        Paragraph(
    ...
    story.append(
        Paragraph(
            "• Reconocer el dialecto de SQLAlchemy <code>sqlalchemy_sqlany</code>.",
            body_style,
        )
    )
    story.append(
        Paragraph(
            "• Manejar correctamente expresiones de agregación de tiempo (segundo, minuto, hora, día, etc.) mediante funciones <code>DATEADD</code> y <code>DATEDIFF</code> nativas de SQL Anywhere.",
            body_style,
        )
    )
    story.append(
    ...
    story.append(
        Paragraph("C. Automatización en Docker (Dockerfile & Script)", h2_style)
    )
    story.append(
        Paragraph(
    ...
    story.append(
        Paragraph("<code>ENV PATH=$PATH:$SQLANY/bin64:$SQLANY/bin32</code>", code_style)
    )
    story.append(
        Paragraph(
            "<code>ENV LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$SQLANY/lib64:$SQLANY/lib32</code>",
            code_style,
        )
    )
    ...
    story.append(
        Paragraph("4. Configuración de Conexión en la Interfaz de Superset", h1_style)
    )
    story.append(
        Paragraph(
    ...
    story.append(
        Paragraph(
            "2. Navegue al menú de la esquina superior derecha: <b>Settings (Ajustes) -> Database Connections (Conexiones a Bases de Datos)</b>.",
            body_style,
        )
    )
    ...
    story.append(
        Paragraph(
            "4. En la ventana emergente, seleccione <b>SAP SQL Anywhere</b> del listado de bases de datos soportadas.",
            body_style,
        )
    )
    story.append(
    ...
    param_data = [
        [
            Paragraph("<b>Parámetro</b>", body_style),
            Paragraph("<b>Descripción</b>", body_style),
            Paragraph("<b>Ejemplo</b>", body_style),
        ],
        [
            Paragraph("Host", body_style),
            Paragraph("Dirección IP o dominio del servidor", body_style),
            Paragraph("192.168.1.50", body_style),
        ],
        [
            Paragraph("Port", body_style),
            Paragraph("Puerto de conexión de SQL Anywhere", body_style),
            Paragraph("2638", body_style),
        ],
        [
            Paragraph("Database", body_style),
            Paragraph("Nombre de la base de datos", body_style),
            Paragraph("mi_bd_produccion", body_style),
        ],
        [
            Paragraph("Username", body_style),
            Paragraph("Usuario con permisos de lectura", body_style),
            Paragraph("dba", body_style),
        ],
        [
            Paragraph("Password", body_style),
            Paragraph("Contraseña de acceso", body_style),
            Paragraph("contraseña_segura", body_style),
        ],
    ]
    ...
    story.append(
        Paragraph(
            "<code>sqlalchemy_sqlany://usuario:contraseña@host:puerto/nombre_base_datos</code>",
            code_style,
        )
    )
    ...
    story.append(
        Paragraph("<b>Error: <code>Could not load dbcapi</code></b>", h2_style)
    )
    story.append(
        Paragraph(
